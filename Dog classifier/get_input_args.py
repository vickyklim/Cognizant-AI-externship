...
#                                                                             
# PROGRAMMER: Victoria Klimkowski
# DATE CREATED:                                   
# REVISED DATE: 
...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str, default='vgg', help='pick CNN model architecture')
    parser.add_argument('--dogfile', type=str, default='dognames.txt', help='names of dogs .txt')
